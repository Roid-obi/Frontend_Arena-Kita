...
export default function OwnerPesanan() {
  ...
  const filteredBookings = bookingsData.filter((b) => b.id.toString().includes(searchQuery) || b.user_id.toString().includes(searchQuery) || b.booking_date.includes(searchQuery));
