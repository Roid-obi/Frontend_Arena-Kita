...
export default function AdminAccount() {
  ...
  return (
    <section>
      <h1 className="text-2xl md:text-3xl font-bold text-[#0d47a1] mb-3">Pengaturan Admin</h1>
      <p className="text-gray-600 mb-6">Pengaturan akun administrator dan preferensi sistem.</p>

      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-20 h-20 bg-[#0d47a1] rounded-full flex items-center justify-center text-white text-2xl font-bold">{profile?.full_name?.charAt(0).toUpperCase() || "A"}</div>
          <div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-500">ID Admin</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <button className="p-4 bg-white shadow-md rounded-lg hover:shadow-lg transition text-left">
          <h3 className="font-semibold mb-2 text-[#0d47a1]">Profil Admin</h3>
          <p className="text-sm text-gray-600">Edit nama, email, dan informasi kontak</p>
        </button>

        <button className="p-4 bg-white shadow-md rounded-lg hover:shadow-lg transition text-left">
          <h3 className="font-semibold mb-2 text-[#0d47a1]">Keamanan</h3>
