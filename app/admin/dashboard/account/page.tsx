  ...
  return (
    <section>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-[#0d47a1] mb-1">Pengaturan Admin</h1>
          <p className="text-gray-600">Pengaturan akun administrator dan preferensi sistem.</p>
        </div>
        {!isEditing && (
      ...
      {!isEditing && (
        <div className="bg-white shadow-md rounded-lg p-4">
          <button className="w-full p-4 hover:bg-gray-50 rounded-lg transition text-left">
            ...
            <p className="text-sm text-gray-600">Ubah kata sandi dan autentikasi 2-faktor</p>
          </button>
        </div>
      )}
    </section>
