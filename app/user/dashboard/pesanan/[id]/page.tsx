        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <span className={`inline-block px-2 py-1 text-xs font-medium rounded ${getStatusColor(booking.booking_status)}`}>{getStatusLabel(booking.booking_status)}</span>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <span
                className={`inline-block px-2 py-1 text-xs font-medium rounded ${
                  payment?.payment_status === "SUCCESS" ? "bg-green-100 text-green-800" : payment?.payment_status === "PENDING" ? "bg-yellow-100 text-yellow-800" : "bg-red-100 text-red-800"
                }`}
              >
