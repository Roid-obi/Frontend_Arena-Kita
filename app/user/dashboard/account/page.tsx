...
export default function DashboardAccount() {
  ...
  return (
    <section>
      <h1 className="text-2xl md:text-3xl font-bold text-[#0d47a1] mb-3">Pengaturan Akun</h1>
      <p className="text-gray-600 mb-6">Informasi akun dan pengaturan profil Anda.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <button className="p-4 bg-white shadow-md rounded-lg hover:shadow-lg transition text-left">
          <h3 className="font-semibold mb-2 text-[#0d47a1]">Ubah Profil</h3>
          <p className="text-sm text-gray-600">Edit nama, foto profil, dan informasi lainnya</p>
        </button>
